...
class IP440Validator(BaseModel):
    company_name: str
    address: str
    email: str
    liaison_officer: str
    ...
    incomes_sales_merchandise_1: float
    incomes_sales_merchandise_2: float
    ...
    others_income_1: float
    others_income_2: float
...
class IP_440FormView():
    def __init__(self, form: IP440Validator):
        self.raw = form
        self.df = []
